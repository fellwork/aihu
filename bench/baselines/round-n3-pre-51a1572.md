...
```
cellx × @aihu/signals … 532.64 ns p50 · 1.81M ops/s
...
wide-fanout-100 × @aihu/signals … 6.60 µs p50 · 151.48K ops/s
...
batched-writes-100 × @aihu/signals … 3.01 µs p50 · 311.07K ops/s
...
deep-propagation-100 × @aihu/signals … 4.02 µs p50 · 250.40K ops/s
...
dynamic-deps × @aihu/signals … 1.14 µs p50 · 928.48K ops/s
...
creation-1to1000 × @aihu/signals … 106.65 µs p50 · 9.21K ops/s
...
- `bun run size` → `@aihu/signals = 1925 B gz` (the canonical size metric per Learning #31)
