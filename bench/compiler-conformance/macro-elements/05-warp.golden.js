...
const createWarpBoundary = (tgt, b) => b();

defineElement('05-warp', defineComponent((_ctx) => {
  return createWarpBoundary('portal-root', () => { return branch('p', undefined, [leaf('Teleported content')]) })
