...
| [`@aihu/compiler-native-darwin-arm64`](./packages/compiler/npm-native/darwin-arm64) | `0.1.11` | aihu compiler native addon (napi) — darwin-arm64 platform binary. |
| [`@aihu/compiler-native-darwin-x64`](./packages/compiler/npm-native/darwin-x64) | `0.1.11` | aihu compiler native addon (napi) — darwin-x64 platform binary. |
| [`@aihu/compiler-native-linux-arm64-gnu`](./packages/compiler/npm-native/linux-arm64-gnu) | `0.1.11` | aihu compiler native addon (napi) — linux-arm64-gnu platform binary. |
...
| [`@aihu/css-engine`](./packages/css-engine) | `0.5.7` | aihu CSS engine — Tailwind v4 hard fork with WC-native scoped output. |
