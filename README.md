...
| [`@aihu/cli`](./packages/cli) | `0.8.1` | Aihu CLI (`aihu`, `create-aihu`) — scaffolding, dev, build commands. |
...
| [`create-aihu`](./packages/create-aihu) | `0.1.2` | Scaffold a new Aihu app — the `npm create aihu` / `npx create-aihu` entry point. Thin delegator to @aihu/cli. |
