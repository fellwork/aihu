...
| [`@aihu/compiler`](./packages/compiler) | `0.9.4` | Single File Component (.aihu) compiler — Rust binary + JS glue. |
...
| [`@aihu/language-server`](./packages/language-server) | `0.2.12` | Cross-editor Language Server (aihu-language-server) for .aihu Single File Components — diagnostics, hover, completion, and quick-fix code actions. |
