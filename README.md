...
| [`@aihu/adapter-cloudflare`](./packages/adapter-cloudflare) | `4.0.1` | Cloudflare Workers/Pages deployment adapter for @aihu/app. |
| [`@aihu/adapter-vercel`](./packages/adapter-vercel) | `4.0.1` | Vercel deployment adapter for @aihu/app. |
...
| [`@aihu/compiler`](./packages/compiler) | `0.9.7` | Single File Component (.aihu) compiler — Rust binary + JS glue. |
...
| [`@aihu/language-server`](./packages/language-server) | `0.2.15` | Cross-editor Language Server (aihu-language-server) for .aihu Single File Components — diagnostics, hover, completion, and quick-fix code actions. |
...
| [`create-aihu`](./packages/create-aihu) | `0.0.0` | Scaffold a new Aihu app — the `npm create aihu` / `npx create-aihu` entry point. Thin delegator to @aihu/cli. |
