...
| `@aihu/arbor` | 2.72 kB | 2800 B | pass |
...
| [`@aihu/mcp-server`](./packages/mcp-server) | `0.1.0` | MCP server for aihu — exposes aihu_example (cookbook SFC lookup) and aihu_validate (compiler diagnostics) via stdio transport. |
