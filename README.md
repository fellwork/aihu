...
| [`@aihu/compiler-native-darwin-arm64`](./packages/compiler/npm-native/darwin-arm64) | `0.1.8` | aihu compiler native addon (napi) — darwin-arm64 platform binary. |
| [`@aihu/compiler-native-darwin-x64`](./packages/compiler/npm-native/darwin-x64) | `0.1.8` | aihu compiler native addon (napi) — darwin-x64 platform binary. |
| [`@aihu/compiler-native-linux-arm64-gnu`](./packages/compiler/npm-native/linux-arm64-gnu) | `0.1.8` | aihu compiler native addon (napi) — linux-arm64-gnu platform binary. |
| [`@aihu/compiler-native-linux-x64-gnu`](./packages/compiler/npm-native/linux-x64-gnu) | `0.1.8` | aihu compiler native addon (napi) — linux-x64-gnu platform binary. |
| [`@aihu/compiler-native-win32-x64-msvc`](./packages/compiler/npm-native/win32-x64-msvc) | `0.1.8` | aihu compiler native addon (napi) — win32-x64-msvc platform binary. |
